...
//            $business_email = "test-hjmwu@mail-tester.com";
            ...
            sendGridEmail("New order ($order_id) from $site_name", $body, $site_name, "tap-in@tapforall.com", $business_email);
        }
        ...
        if ($goodToSendSMS) {
            if (!empty($sms_numbers)) {
                ...
                foreach ($sms_numbers_array as $sms_no) {
                    $this->m_site->smsMerchant("New order ($order_id) from $site_name", $sms_no, $business_id);
                }
            }
        } // if
    ...
    function test_sendGrid_mail_to_consumer() {

        $to = "aamirmansoury@gmail.com";
        $subject = "Subject of your email";
        $email_body = "The text for the mail...";
        $site_name = SiteName;
        sendGridEmail("New order from $site_name", "Hello there!", "Tap In", "tap-in@tapforall.com", "aamirmansoury@gmail.com");
    }
