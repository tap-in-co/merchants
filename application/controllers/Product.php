...
//    }
    ...
    function get_product_fields($param) {

        $param['businessID'] = $param['businessID'] ?? '';
        $param['name'] = $param['name'] ?? '';
        $param['price'] = $param['price'] ?? '';
        $param['product_category_id'] = $param['product_category_id'] ?? '';

        $param['SKU'] = $param['SKU'] ?? '';
        $param['short_description'] = $param['short_description'] ?? '';
        $param['long_description'] = $param['long_description'] ?? '';
        $param['pictures'] = $param['pictures'] ?? '';

        $param['detail_information'] = $param['detail_information'] ?? '';
        $param['runtime_fields'] = $param['runtime_fields'] ?? '';
        $param['runtime_fields_detail'] = $param['runtime_fields_detail'] ?? '';
        $param['sales_price'] = $param['sales_price'] ?? '';
        $param['has_option'] = $param['has_option'] ?? '';
        $param['bought_with_rewards'] = $param['bought_with_rewards'] ?? '';
        $param['more_information'] = $param['more_information'] ?? '';
	...
	function insert() {
		is_login() ? '' : redirect('index.php/login');
		$param = $_REQUEST;
		$param = $this->get_product_fields($param);
...
//    }
 ...
 function set_product_order()
	...
	function update() {
		is_login() ? '' : redirect('index.php/login');
		$param = $this->get_product_fields($_REQUEST);
